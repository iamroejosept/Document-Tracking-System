...
if (isset($_POST["region"])) {
  ...
  $query = "SELECT DISTINCT Province FROM OfficeSettings WHERE Region = '$region'";
  ...
  $query = "SELECT DISTINCT cityMunicipality FROM OfficeSettings WHERE Province = '$province'";
  $result = mysqli_query($connect, $query);
  $options = "";
  while ($row = mysqli_fetch_array($result)) {
