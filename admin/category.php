...
<head>
   ...
   <script>
      $(document).ready(function() {
         ...
         //Function for deleting document category record
      $('#delete').on('show.bs.modal', function(e) {
            ...
            $('#delete-category-link').click(function(event) {
               ...
               $.ajax({
                  ...
                  error: function(e) {
                     $.alert({
                        title: 'Error!',
                        content: 'Failed to delete document category due to error',
                        type: 'red',
                        buttons: {
                           ok: {
                           text: 'OK',
...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="content-wrapper">
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                        <h1 class="m-0">Document Category</h1>
                  </div>
                  <div class="col-sm-6">
         ...
         <section class="content">
            <div class="container-fluid">
               <div class="card card-info">
                  <form action="../php/addCategory.php" method="post" id="addCategoryForm">
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group">
                                       <label>Document Category Name</label>
                                       <input type="text" class="form-control" name="addDCN" placeholder="Document Name">
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <div class="form-group">
                                 ...
                                 while($row = mysqli_fetch_array($result)){  
                                    ...
                                    <tr>
                                          ...
                                          <td class='text-center'>
                                             <a class='btn btn-sm btn-success' href='#' data-toggle='modal' data-target='#edit' data-category-id='$DocumentCategoryId' data-category-name='$DocumentCategoryName' data-description='$Description' onclick='populateEditModal(this)'><i class='fa fa-edit'></i>Update</a>
                                             <a class='btn btn-sm btn-danger' href='#' data-toggle='modal' data-target='#delete' data-category-id='$DocumentCategoryId'>
         ...
         <div class="modal-content">
            <div class="modal-body text-center">
               ...
               <div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
                  <a type="submit" class="btn btn-danger" id="delete-category-link">Delete</a>
               </div>
            </div>
         </div>
      </div>
   ...
   <div id="edit" class="modal animated rubberBand delete-modal" role="dialog">
      <div class="modal-dialog modal-dialog-centered modal-lg">
         <div class="modal-content">
            <div class="modal-body text-center">
               <form action="../php/saveCategory.php" method="post" id="editCategoryForm">
                  <div class="card-body">
                     <div class="row">
                        <div class="col-md-12">
                           <div class="card-header">
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <input id="editTxtDCN" type="text" name="editDCN" class="form-control">
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <div class="form-group">
                                    <label class="float-left">Description</label>
                                    <textarea id="editTADescription" name="editDescription" class="form-control"></textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="card-footer">
                     ...
                     <button id="documentCategorySave" type="submit" class="btn btn-info" style="background-color: rgb(22,94,155);">Save</button>
                  </div>
               </form>
            </div>
         </div>
